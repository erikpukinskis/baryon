...
import type { WebScaleFateKey } from "~/model/01_WEB_SCALE_FATES"
import type { HaloScaleFateKey } from "~/model/02_HALO_SCALE_FATES"
import type { GalacticScaleFateKey } from "~/model/03_GALACTIC_SCALE_FATES"
import type { InterstellarScaleFateKey } from "~/model/04_INTERSTELLAR_SCALE_FATES"
...
type FateColor<K extends string> = {
  key: K
  hex: string
  description: string
}

export const WEB_SCALE_FATE_COLOR_ARRAY: FateColor<WebScaleFateKey>[] = [
  {
    key: "void",
    hex: "#0a0a0f",
    description:
 ...
 */
export const HALO_SCALE_FATE_COLOR_ARRAY: FateColor<HaloScaleFateKey>[] = [
  {
    key: "empty",
    hex: "#0a0a12",
    description:
...
export const GALACTIC_SCALE_FATE_COLOR_ARRAY: FateColor<GalacticScaleFateKey>[] =
  [
    {
      key: "diffuseHalo",
      hex: "#0d1117",
 ...
 */
export const INTERSTELLAR_SCALE_FATE_COLOR_ARRAY: FateColor<InterstellarScaleFateKey>[] =
  [
    {
      key: "diffuseISM",
      hex: "#1a1a2e",
